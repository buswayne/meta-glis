...
from losses import WeightedMSELoss, WeightedSoftmaxMSELoss, SoftmaxLoss
import os
...
def train_one_epoch(model, dataloader, optimizer, criterion, device, minimize_over_X=True):
    ...
    for batch in dataloader:
        ...
        if minimize_over_X:
            ...
            loss = criterion(reconstructed_f, fopt, weights)
...
def main():
    ...
    checkpoint_path = f"out/rosenbrock/with_exploration/model_{input_dim}d_{latent_dim}l_softmax_{X_or_f}.pt"
    model_dir = 'out'
